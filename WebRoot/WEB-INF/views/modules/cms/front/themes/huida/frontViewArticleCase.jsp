...
<body>
	...
	<div class="toppic">
	 ...
	 <div class="toppic-title left">
			...
			<span class="toppic-title-span">客户案例详情</span>
			<p>News Information</p>
		</div>
		<div class="right toppic-progress">
			<span><a href="news.html" class="w-white">客户案例</a></span>
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="news-inform.html" class="w-white">案例详情</a></span>
		</div>
	</div>
</div>
...
<div class="am-container-1 margin-t30">
	<div class="words-title ">
		...
		<div><fmt:formatDate value="${article.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
	</div>
</div>
