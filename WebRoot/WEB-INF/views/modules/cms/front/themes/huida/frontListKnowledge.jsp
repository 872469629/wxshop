...
<div class="toppic">
	 ...
	 <div class="toppic-title left">
			...
			<span class="toppic-title-span">知识库</span>
			<p>Product Show</p>
		</div>
		<div class="right toppic-progress">
			<span><a href="index.html" class="w-white">首页</a></span>
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="product-show.html" class="w-white">知识库列表</a></span>
		</div>
	</div>
</div>
...
<div class="left am-u-sm-12 am-u-md-8 am-u-lg-9 ">
	...
	<c:forEach items="${page.list}" var="article">
	    <li >
	    	<div class="product-content">
			    	...
			    	<div class="">
			    		<div class="">
			    			<div><a href="${ctx}/view-${article.category.id}-${article.id}${urlSuffix}">${fns:abbr(article.title,40)}</a></div>
			    			<i class="am-icon-dribbble"></i>
			    		</div>
			    		<div class="product-intro">
			    			<span>摘要：<fmt:formatDate value="${article.updateDate}" pattern="yyyy.MM.dd"/></span>
	...
	<section data-am-widget="accordion" class="am-accordion am-accordion-gapped" data-am-accordion='{  }'>
		<div class="hot-title"><i class="am-icon-thumbs-o-up"></i>知识库分类 / Hot 	News</div>
